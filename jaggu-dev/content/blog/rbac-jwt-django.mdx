...
And the fix I still need to apply to `ProductsListAPIView` — the list view serializer also renders `images`, so it needs:
...
## Mistake 6: The cart view — where N+1 still lives

Here's one I haven't fully fixed yet, and it's worth being honest about.
